...
type reservationStore interface {
	...
	CommitSlot(ctx context.Context, sagaID uuid.UUID, subscriptionID int64) error
	ReleaseSlot(ctx context.Context, sagaID uuid.UUID, subscriptionID int64) error
}
...
func (s *Service) CommitSubscriptionSlot(ctx context.Context, sagaID uuid.UUID, subscriptionID int64) error {
	return s.reservations.CommitSlot(ctx, sagaID, subscriptionID)
}

func (s *Service) ReleaseSubscriptionSlot(ctx context.Context, sagaID uuid.UUID, subscriptionID int64) error {
	return s.reservations.ReleaseSlot(ctx, sagaID, subscriptionID)
}
